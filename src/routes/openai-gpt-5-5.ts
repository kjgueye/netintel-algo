...
// POST /openai/gpt-5-5 — pay-per-call x402 passthrough to OpenAI's gpt-5.5 chat
// completions. No OpenAI account or key needed by the caller; they pay $0.65 in
...
//
// gpt-5.5 is a reasoning-family model → reasoning:true, which switches the token
...
// 8192 tok, worst-case OpenAI spend at gpt-5.5's $5.00/$30.00 per-1M rates is
...
export const openaiGpt55Router = makeOpenAiRouter(openAiModel("/openai/gpt-5-5"));
