...
// POST /openai/gpt-5-4 — pay-per-call x402 passthrough to OpenAI's gpt-5.4 chat
// completions. No OpenAI account or key needed by the caller; they pay $0.25 in
...
//
// gpt-5.4 is a reasoning-family model → reasoning:true, which switches the token
...
// 4096 tok, worst-case OpenAI spend at gpt-5.4's $2.50/$15.00 per-1M rates is
...
export const openaiGpt54Router = makeOpenAiRouter(openAiModel("/openai/gpt-5-4"));
