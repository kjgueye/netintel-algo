...
// POST /openai/gpt-5-1 — pay-per-call x402 passthrough to OpenAI's gpt-5.1 chat
// completions. No OpenAI account or key needed by the caller; they pay $0.15 in
...
//
// gpt-5.1 is a reasoning-family model → reasoning:true, which switches the token
...
// 4096 tok, worst-case OpenAI spend at gpt-5.1's $1.25/$10.00 per-1M rates is
...
export const openaiGpt51Router = makeOpenAiRouter(openAiModel("/openai/gpt-5-1"));
